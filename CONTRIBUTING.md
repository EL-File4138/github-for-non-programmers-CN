...
~~由于本文为原文的简体中文翻译作，为忠实于原文，`master` 分支上不接受内容更新请求。如果希望增补更新内容，请向原仓库提交。~~

~~鉴于原仓库已经久久未见更新，如果想参与本仓库 Owner 的文档更新编写，请自行fork，增补后提交PR，并请仅提交至 `next` 分支。~~

~~因此，以下的贡献指南不做翻译。~~

由于原文档大面积过时，本翻译版本将大幅度重写。任何贡献请直接提交至 `master` 的 PR。
